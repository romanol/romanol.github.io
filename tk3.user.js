...
pus2 = 14; //до этого уровня создавать бой в пустоши (твой уровень-2)
...
legendsLink(legendsHrefLink("fire"), 50/speed);
legendsLink(legendsFindLink("Обновить"), 1000/speed);
